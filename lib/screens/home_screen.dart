...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _btnSlide = Tween<Offset>(begin: const Offset(0, 0.40), end: Offset.zero)
        .animate(
          CurvedAnimation(
            parent: _entranceCtrl,
  ...
  Widget build(BuildContext context) {
    // Reconstruit quand le thème change
    return ValueListenableBuilder<ThemeMode>(
      valueListenable: themeNotifier,
      builder: (context, mode, _) {
        final isDark = _isDarkMode(context, mode);
        final p = _P(isDark);
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                _BrandMark(isDark: isDark, palette: p),
                                _ThemeToggle(
                                  isDark: isDark,
...
class _BrandMark extends StatelessWidget {
  ...
  const _BrandMark({required this.isDark, required this.palette});
    ...
    return Row(
      children: [
        Container(
          ...
          child: const Center(
            child: Text('✦', style: TextStyle(color: _gold, fontSize: 11)),
          ),
        ),
        ...
        Text(
          ...
          style: TextStyle(
            ...
            color: palette.onBg.withOpacity(0.45),
            letterSpacing: 4,
          ),
        ),
      ],
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: _gold.withOpacity(isDark ? 0.06 : 0.10),
        ),
        child: Row(
          children: [
            Icon(
...
class _LuxuryCitiesCard extends StatelessWidget {
  ...
  const _LuxuryCitiesCard({required this.shimmerCtrl, required this.palette});
    ...
    return Padding(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) => CustomPaint(
          foregroundPainter: _GoldShimmerBorderPainter(
            progress: shimmerCtrl.value,
          ),
          child: child,
        ),
        child: AnimatedContainer(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: _cities
                    .map((c) => _LuxuryCityPill(data: c, palette: palette))
                    .toList(),
              ),
            ],
          ),
...
class _GoldShimmerBorderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final tangent = hm.first.getTangentForOffset(0);
  ...
  @override
  bool shouldRepaint(_GoldShimmerBorderPainter old) => old.progress != progress;
}
...
class _CityData {
  ...
  const _CityData({required this.flag, required this.city, required this.sub});
}
    ...
    return Column(
      ...
      children: [
        AnimatedContainer(
          ...
          child: Center(
            child: Text(data.flag, style: const TextStyle(fontSize: 22)),
          ),
        ),
